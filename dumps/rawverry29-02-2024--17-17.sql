...
CREATE TABLE `product_size_link` (
  ...
  `product_price_recuded` decimal(10,2) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `product_id` (`product_id`),
  KEY `size_id` (`size_id`),
...
INSERT INTO `product_size_link` VALUES (39,88,14,123.00,NULL),(40,88,15,NULL,NULL),(41,87,16,123.00,NULL),(55,87,14,256.00,NULL);
...
-- Dump completed on 2024-02-29 17:17:12
